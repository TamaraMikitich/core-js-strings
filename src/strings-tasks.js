 ...
 */
function removeLeadingWhitespaces(x) {
  return x.trimStart(0);
}
 ...
 */
function removeTrailingWhitespaces(x) {
  return x.trimEnd(0);
}
...
function removeFirstOccurrences(str, value) {
  ...
  return str.slice(0, x) + str.slice(x + value.length);
}
